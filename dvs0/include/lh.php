...
<fieldset style="box-shadow:0 0 5px #999;background-color:#e8e8e8e8; width:640px;margin-top:5px;margin-left:0px;margin-right:0px;font-size:12px;border-top-left-radius: 5px; border-top-right-radius: 5px;border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;">
...
for ($i = 0;  ($i <= 29); $i++) { //Last 20 calls
	if (isset($lastHeard[$i])) {
		...
		if ((is_numeric($listElem[2]) || strpos($listElem[2], "openSPOT") !== FALSE) && (strlen($listElem[2])==7)) {
		    echo "<td align=\"left\" style=\"color:#464646;\">&nbsp;<span style=\"color:#464646;font-weight:bold;\">$listElem[2]</span></a></td>";
			...
			echo "<td align=\"left\">&nbsp;<b>$listElem[2]</b></a><span style=\"color:#464646;font-weight:bold;\">/$listElem[3]</span></td>";
		    } else {
