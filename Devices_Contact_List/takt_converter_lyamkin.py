...
file_hy685_contact = "HYTERA_HP685.xls"
...
## Делаем файл для Takt_Contact_Ru
book = openpyxl.Workbook()
book.remove(book.active)
...
sheet2["D1"].value = ""
sheet2.insert_rows(0)
sheet2["A1"].value = "Info3"
sheet2["B1"].value = "0"
sheet2["B1"].value = "0"
sheet2["C1"].value = "Private Call"
sheet2.insert_rows(0)
sheet2["A1"].value = "Info2"
sheet2["B1"].value = "0"
sheet2["B1"].value = "0"
sheet2["C1"].value = "Group Call"
sheet2.insert_rows(0)
sheet2["A1"].value = "Info1"
sheet2["B1"].value = "0"
sheet2["B1"].value = "0"
sheet2["C1"].value = "Call Type"
...
for col in range(6, sheet2.max_row+1):
    sheet2['A' + str(col)].value = col-5
    sheet2['C' + str(col)].value = 'Private Call'
sheet2["C6"].value = "Group Call"
sheet2["C7"].value = "Group Call"
u_id = u_alias = sheet2['B']
id1list=[]
for x in range(len(u_alias)):
    if u_id[x].value==None:
